    ...
    <CRow>
      <CCol sm="12" xl="12">
        <CCard className="mx-4">
          <CCardHeader>
            <h4>MainCode Register</h4>
            <small>Create your MainCode</small>
          </CCardHeader>
...
export default MainCodeRegister;

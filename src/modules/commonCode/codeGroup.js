...
const [
  GET_CODEGROUPLIST,
  GET_CODEGROUPLIST_SUCCESS,
  GET_CODEGROUPLIST_FAILURE,
] = createRequestActionTypes("common/GET_CODEGROUPLIST");

// 코드그룹 추가
const [
  POST_CODEGROUP,
  POST_CODEGROUP_SUCCESS,
  POST_CODEGROUP_FAILURE,
] = createRequestActionTypes("common/POST_CODEGROUP");

// 코드그룹 삭제
const [
  DELETE_CODEGROUP,
  DELETE_CODEGROUP_SUCCESS,
  DELETE_CODEGROUP_FAILURE,
] = createRequestActionTypes("common/DELETE_CODEGROUP");

// 코드그룹 수정
const [
  PUT_CODEGROUP,
  PUT_CODEGROUP_SUCCESS,
  PUT_CODEGROUP_FAILURE,
] = createRequestActionTypes("common/PUT_CODEGROUP");
...
export const postCodeGroup = createAction(
  POST_CODEGROUP,
  ({ definition, id }) => ({ definition, id })
);
export const deleteCodeGroup = createAction(DELETE_CODEGROUP, (id) => id);
export const putCodeGroup = createAction(
  PUT_CODEGROUP,
  ({ definition, id }) => ({ definition, id })
);
